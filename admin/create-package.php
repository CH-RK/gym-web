...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"> Price in Rupees</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Price is Rs" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="packagedetails" id="packagedetails" placeholder="Plan Details" required></textarea> 
									</div>
								</div>															
<div class="form-group">
